import { TestTube, BadgeCheck, Zap, Activity } from "lucide-react";
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 22 }}>
        {FEATURES.map((f, i) => {
          ...
          return (
            ...
            >
              <div style={{ background: f.accent, borderRadius: 8, width: 38, height: 38, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 20 }}>
